...
import com.example.flowtest.SampleActivity;
...
public class NotificationsActivity {
    ...
    public static void setNextAlarm(Context context){
        ...
        if (current_survey_id == 0) //if no survey ongoing
            ...
            if (alarm_hour > hour_max || (alarm_hour == hour_max && alarm_minute > minute_max) || alarm_hour < hour_min || (alarm_hour == hour_min && alarm_minute < minute_min)) {
                ...
                Log.d("Flow_Valeur", "postponed time = " + NextDate2);
            }
    ...
    public static void CreateNotification (Context context){
        ...
        String notifText= context.getString(R.string.notifText1)+" "+Integer.toString(next_sample_id) + " " + context.getString(R.string.notifText2);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, channel_id)
                .setSmallIcon(R.drawable.ic_stat_call_white) //a remplacer!!!!!!!!!!!!!
