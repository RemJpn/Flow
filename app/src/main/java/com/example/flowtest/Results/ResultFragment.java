...
import com.example.flowtest.Results.DetailsActivity;
...
public class ResultFragment extends Fragment {
    ...
    private View.OnClickListener barListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Log.d("Flow_value","View ID = " +v.getId());
            Log.d("Flow_value","Who bar ID = " +R.id.who_bar);
            Log.d("Flow_value","Why bar ID = " +R.id.why_bar);
    ...
    private View.OnClickListener detailsListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Log.d("Flow_value","Selected survey = "+survey_nb);
            editor.apply();
